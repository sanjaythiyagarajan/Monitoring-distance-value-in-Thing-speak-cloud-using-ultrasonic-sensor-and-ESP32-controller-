...
char ssid[] = "OPPO Reno8 5G Sanjay"; //SSID
char pass[] = "123456780"; // Password
...
unsigned long myChannelField = 2711845; // Channel ID
const int ChannelField = 1; // Which channel to write data
const char * myWriteAPIKey = "4LYC29G493V6WC4H"; // Your write API Key
